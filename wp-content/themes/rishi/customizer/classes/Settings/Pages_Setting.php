...
class Pages_Setting extends Customize_Settings{

	protected function add_settings() {

		$pages_defaults = self::get_pages_default_value();

		$prefix = 'single_page_';

		$this->add_setting('pages_title_panel', array(
			'label'         => __( 'Page Title', 'rishi' ),
			'control'       => ControlTypes::PANEL,
			'innerControls' => apply_filters(
				'rishi__pages_page_title_inneroptions',
				array(
					'breadcrumbs_ed_single_page' => array(
						'label'   => __( 'Breadcrumb', 'rishi' ),
						'control' => ControlTypes::INPUT_SWITCH,
						'value'   => $pages_defaults['breadcrumbs_ed_single_page'],
						'divider' => 'bottom',

					),
					'page_title_panel'           => array(
		...
		$this->add_setting('rishi_single_page_general_tab', array(
			...
			'options' => array(
				'page_sidebar_layout'                 => array(
					...
					'value'   => $pages_defaults['page_sidebar_layout'],
					'attr'    => array(
						'data-type'    => 'background',
						'data-usage'   => 'layout-style',
						'data-columns' => '2',
					),
					'help'    => __( 'Choose sidebar layout for page.', 'rishi' ),
					'choices' => array(
				...
				'page_layout'                         => array(
					...
					'value'   => $pages_defaults['page_layout'],
					'design'  => 'block',
					'divider' => 'top',
					...
					'help'    => __( 'Choose page container layout.', 'rishi' ),
				),
				'page_layout_streched_ed'             => array(
				...
				$prefix . 'featured_image_ratio'      => array(
				...
				$prefix . 'featured_image_scale'      => array(
				...
				$prefix . 'featured_image_size'       => array(
				...
				$prefix . 'featured_image_visibility' => array(
				...
				'page_content_area_spacing'           => array(
		...
		$this->add_setting('rishi_single_page_design_tab', array(
	...
	/**
	 * Set default value for pages.
	 */
	protected static function get_pages_default_value() {
